...
Template.callVideo.created = function() {
...
Template.callVideo.destroyed = function() {
  return this._webRTCSignaller.stop();
};

Template.callVideo.helpers({
  roomName: function() {
    var roomName;
    roomName = Session.get('roomName');
    if (roomName) {
      return Meteor.absoluteUrl(Router.path('webrtc', {
        roomName: roomName
      }).slice(1));
    }
  },
